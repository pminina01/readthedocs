NLog 4.5 introduces structured logging - also called semantic logging that supports the message templates specification. This document describes how to use structural logging. The implementation in NLog uses the message templates rules and so it's also recommend to check: https://messagetemplates.org/
